...
export function __wbindgen_cast_3dfc7e389255604d(arg0, arg1) {
    ...
    const ret = makeMutClosure(arg0, arg1, 383, __wbg_adapter_9);
    return addHeapObject(ret);
};
...
export function __wbindgen_cast_6304fee0280cf682(arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { dtor_idx: 342, function: Function { arguments: [NamedExternref("Array<any>"), NamedExternref("ResizeObserver")], shim_idx: 348, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    const ret = makeMutClosure(arg0, arg1, 342, __wbg_adapter_18);
    return addHeapObject(ret);
};

export function __wbindgen_cast_80ef9c1a80d206d7(arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { dtor_idx: 342, function: Function { arguments: [], shim_idx: 346, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
